...
func (o *operationsCenterOSUpdate) DownloadUpdate(ctx context.Context, _ string, targetPath string, progressFunc func(float64)) error {
...
func (o *operationsCenterOSUpdate) DownloadImage(ctx context.Context, imageType string, _ string, targetPath string, progressFunc func(float64)) (string, error) {
	// Create the target path.
	err := os.MkdirAll(targetPath, 0o700)
	if err != nil {
		return "", err
