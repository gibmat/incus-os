...
// swagger:operation POST /1.0/applications/{name}/:set-version applications applications_post_set_version
//
//	Configure the version of the application
//
//	Set the version of the application to a version available locally on disk. If no version is
...
//	  "500":
//	    $ref: "#/responses/InternalServerError"
func (s *Server) apiApplicationsSetVersion(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
