...
func (s *Server) apiSystemSecurity(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodGet:
		...
		// Get TPM status.
		s.state.System.Security.State.TPMStatus = secureboot.TPMStatus(r.Context())
