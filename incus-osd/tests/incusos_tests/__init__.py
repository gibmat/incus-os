...
from . import tests_incusos_api, tests_incusos_api_applications, tests_incusos_api_debug, tests_incusos_api_services, \
    ...
    tests_incusos_api_system_update, tests_install_external_seed, tests_install_smoke, tests_install_system_checks, \
    tests_recovery, tests_secureboot_key_rotation, tests_seed_applications, tests_seed_install, tests_upgrade
